            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li><a class="nav-link" href="{{ route('login') }}">{{Lang::get('userForm.login')}}</a></li>
                            <li><a class="nav-link" href="{{ route('register') }}">{{Lang::get('userForm.register')}}</a></li>
                        @else
