...
@section('content')
    <div class="col-lg-12">
        <h1>{{Lang::get('admin/media.media')}}</h1>
        @if($photos)
            <form action="delete/media" method="post" class="form-inline">
                ...
                <div class="form-group">
                    <select name="checkBoxArray" id="" class="form-control">
                        <option value="">{{Lang::get('admin/media.delete')}}</option>
                    </select>
                    <div class="form-group">
                        <input type="submit" name="delete_all" class="btn btn-primary"
                               value="{{Lang::get('admin/media.confirm')}}">
                    </div>
                </div>
            ...
            <table class="table table-striped">
                <thead>
                  <tr>
                      ...
                      <th>#</th>
                      <th>{{Lang::get('admin/media.pic')}}</th>
                      <th>{{Lang::get('admin/media.created')}}</th>
                      <th>{{Lang::get('admin/media.belongsTo')}}</th>
                  </tr>
                </thead>
                <tbody>
